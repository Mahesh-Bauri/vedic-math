...
function generateComplement(): {
	...
	// 	b = Math.floor(Math.random() * 50) + 950;
	// }
	const num = Math.floor(Math.random() * base);

	return {
		question: `${num}`,
		answer: base - num,
		hint: `The complement of ${num} from the base ${base} is ${base - num}`,
	};
}

// Ekadhikena Purvena - By one more than the previous one
function generateEkadhikena(): {
	question: string;
	answer: number;
	hint: string;
} {
...
export const vedicTechniques: VedicTechnique[] = [
	{
		...
		description:
			"All from 9 and the last from 10 - Perfect for multiplying numbers close to powers of 10",
	...
	{
		id: "complement",
		name: "Nikhilam Sutra (Complement)",
		sanskrit: "निखिलं नवतश्चरमं दशतः",
		description:
			"All from 9 and the last from 10 - Perfect for complements of numbers",
		category: "complement",
		difficulty: "beginner",
		generateProblem: generateComplement,
	},
	{
		id: "ekadhikena",
		...
		description:
			"By one more than the previous one - Instantly square numbers ending in 5",
		category: "squares",
		difficulty: "beginner",
	...
	},
	{
		...
		description:
			"Vertically and crosswise - General multiplication method for any numbers",
		category: "multiplication",
	...
	},
	{
		...
		sanskrit: "यावदूनम्",
		description:
			"Whatever the extent of deficiency - For squaring numbers near a base",
		category: "squares",
		difficulty: "intermediate",
